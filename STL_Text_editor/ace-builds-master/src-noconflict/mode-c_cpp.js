...
var c_cppHighlightRules = function() {
    ...
    var keywordControls = (
        ...
        "return|switch|while|catch|operator|try|throw|using|global|" + 
		"until|event"
    );
    ...
    this.$rules = { 
        "start" : [
            ...
            DocCommentHighlightRules.getStartRule("doc-start"),
            {
                ...
                regex : "0[xX][0-9a-zA-z]+(L|l|UL|ul|u|U|F|f|ll|LL|ull|ULL)?\\b"
            }, {
                ...
                regex : "#\\s*(?:endif|if|ifdef|else|elif|ifndef|G|U|F)\\b"
            }, {
                token : "support.function.C99.c",
                regex : cFunctions
            }, {
                token : keywordMapper,
                regex : "[a_zA-Z_$][a-zA-Z0-9_$][^GUF_$]*"
            }, {
